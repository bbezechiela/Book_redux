                    ...
                    <table class="datatables-basic table border-top dataTable no-footer dtr-column collapsed"
                        ...
                        <tbody>
                            <tr class="odd">
                                ...
                                <td><a href="/products" class="list-details">View Listing Details</a></td>
                                <td>Prohibited item</td>
                                <td>This contains sexual content.</td>
                                <td>11/10/2023</td>
                                <td>Unresolved</td>
                                <td>
                            ...
                            <tr class="even">
                                ...
                                <td><a href="#" class="list-details">View Listing Details</a></td>
                                <td>Prohibited item</td>
                                <td>This contains sexual content.</td>
                                <td>11/10/2023</td>
                                <td>Solved</td>
                                ...
                                <td>Listing has been deleted</td>
                            </tr>
                            <tr class="odd">
                                <td class="control" tabindex="0" style=""></td>
                                <td class="  dt-checkboxes-cell"><input type="checkbox"
