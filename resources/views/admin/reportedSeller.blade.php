                    ...
                    <table class="datatables-basic table border-top dataTable no-footer dtr-column collapsed"
                        ...
                        <tbody>
                            <tr class="odd">
                                ...
                                <td><a href="/products" class="list-details">Central Book</a></td>
                                <td>Scammer</td>
                                <td>This store is not reliable.</td>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center book-image">
                                ...
                                <td>
                                    <div class="d-inline-block"><a href="javascript:;"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end m-0" style="">
                                            ...
                                            <li><a href="javascript:;"
                                                    class="dropdown-item text-danger delete-record">Suspend account</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
