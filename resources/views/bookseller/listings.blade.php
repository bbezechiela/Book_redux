                    ...
                    <div id="content-cards" class="w-100 mx-2 row justify-content-start px-4"
                        style="height: 300px; margin-top: 2em;">
                            <div class="card col-3 m-1 shadow" style="width: 240px; flex: 0 0 auto;">
                                ...
                                <span id="exchange_preferences_"
                                    hidden>I prefer anything haha</span>

                                <span id="rental_duration_"
                                    hidden>1 month</span>
                                <span id="rental_terms_and_condition_"
                                    hidden>Nothing terms and conditions</span>
                                <span id="security_deposit_"
                                    hidden>P200</span>

                                <img id="photo_" data-filename=""
                                    src="../assets/brown_book.png" class="img mx-auto p-2"
