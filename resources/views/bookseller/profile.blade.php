...
<div id="body-container" class="container-fluid px-0 body">
    ...
    <div id="content" class="pe-0 content">
        ...
        @endif
        <form id="form" action="/profileupdate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row px-3 py-3 mx-3">
                ...
                <div class="col-3 d-flex align-items-center flex-column px-5 py-3">
                    ...
                    <button type="submit" onclick="document.getElementById('form').submit()" class="btn save-button">Save</button>
                </div>
                <div class="col mx-2 d-flex justify-content-center flex-column w-50">
                    <div class="form-outline mt-4">
                        <input type="text" id="ownerName" name="owner_name" value="{{ $user->owner_name }}"
                    ...
                    <div class="form-outline mt-4">
                        <input type="text" id="registration_number" name="registration_number"
                            value="{{ $user->registration_number }}" class="form-control" required />
                ...
                <div class="col mx-2 d-flex justify-content-center flex-column w-50">
                    ...
                    <div class="form-outline mt-4">
                        <input type="text" id="phoneNumber" name="phone_number" value="{{ $user->phone_number }}"
                            class="form-control" required />
                    ...
                    <div class="form-outline mt-4">
                        <input type="text" id="date_registered" name="date_registered" class="form-control"
                            value="{{ $user->date_registered }}" onfocus="(this.type='date')"
