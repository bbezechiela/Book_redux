    ...
    <div id="content" class="pe-0 border content">
        ...
        <div class="order-cart d-print-none">
            <div class="name-cart d-flex justify-content-between">
                <div>
                    <a class="seller-name"
                        href="#"><span>Nestine Navarro</span></a>
            ...
            <div class="product-cart">
                <div class="book-details">
                    <div class="left-section">
                        <img src="../assets/brown_book.png" alt="book" width="80px"
                            height="110px">
                        <div class="book-info">
                            <p class="mb-0 book-title">Maria Clara</p>
                    ...
                    <div class="right-section">
                        <div class="book-price">
                            ...
                            <p class="text-total">Total Payment:<span class="product-total">₱100</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="order">
                    <div class="order-details">
                        ...
                        <div class="button-group">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-sm btn-secondary dropdown-toggle arrange-button" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Arrange Shipment
                                </button>
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item btn btn-sm" href="#" data-bs-toggle="modal"
                                    data-bs-target="#arrange-shipment">Arrange Shipment for Sale</a></li>
                                  <li><a class="dropdown-item btn btn-sm" href="#" data-bs-toggle="modal"
                                    data-bs-target="#arrange-shipment">Arrange Shipment for Rent</a></li>
                                </ul>
                              </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Arrange Shipment for Sale</h1>
