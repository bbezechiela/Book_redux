...
<ul class="nav">
    <a href="/dashboard" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('dashboard*')) active @endif" data-blade="dashboard">
        <i class="fa fa-tachometer d-flex align-items-center" aria-hidden="true"></i>
        <span class="nav-link">Dashboard</span>
    </a>
    <a href="/manageuserlisting" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('manageuserlisting*')) active @endif" data-blade="manageListing" style="white-space: nowrap">
        <i class="fa fa-th-list d-flex align-items-center" aria-hidden="true"></i>
        <span class="nav-link">Manage User Listings</span>
    </a>
    <a href="/managesellingclub" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('managesellingclub*')) active @endif" data-blade="manageSellingClub" style="white-space: nowrap">
        <i class="fa fa-linode d-flex align-items-center" aria-hidden="true"></i>
        <span class="nav-link">Manage Book Selling Club</span>
    </a>
    <a href="/manageexchangeclub" id="wishlist-side-btn" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('manageexchangeclub*')) active @endif" data-blade="manageExchangeClub" style="white-space: nowrap">
        <i class="fa fa-exchange d-flex align-items-center" aria-hidden="true"></i>
        <span class="nav-link">Manage Book Exchange Club</span>
    </a>
    <a href="/managerentingclub" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('managerentingclub*')) active @endif" data-blade="manageRentingClub" style="white-space: nowrap">
    ...
    <a href="/managerefund" class="btn nav-item d-flex flex-row w-100 px-5 py-0 sidebar-btn @if(Request::is('managerefund*')) active @endif" data-blade="manageRefund" style="white-space: nowrap">
