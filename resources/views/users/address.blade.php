...
<div id="body-container" class="container-fluid px-0">
    ...
    <div id="content" class="content">
        ...
        <div class="address-container">
            ...
            <button class="btn add-button" data-bs-toggle="modal" data-bs-target="#add-address"><i class="fa fa-plus"
                    aria-hidden="true"></i>Add new address</button>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="contact-number" name="contact_number"
                                    placeholder="Contact Number" style="margin-bottom: 20px; color: #003060;" required>
                                ...
                                <input type="text" class="form-control" id="city_municipality" name="city_municipality"
                                    placeholder="City/Municipality" style="color: #003060;" required>
                                <div id="city_municipality-autocomplete" class="autocomplete"></div>

                                <label for="brgy" class="form-label" style="margin-top: 20px">Barangay/Village</label>
                                ...
                                <input type="text" class="form-control" id="street" name="street_building_house"
                ...
                <div class="modal-content">
                    ...
                    <form id="edit_form" method="POST">;
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <label for="street" class="form-label" style="margin-top: 20px">Street Name,
                                    Building,
                                    House No.</label>
                                <input type="text" class="form-control" id="edit-street" name="street_building_house"
                                    placeholder="Street Name, Building, House No."
                                    style="margin-bottom: 50px; color: #003060;" required>
                            </div>
                            <div class="form-check">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary close-button"
                                data-bs-dismiss="modal">Close</button>
                            <button type="submit" id="edit_form_submit" class="btn save-button">Update</button>
                        </div>
                    </form>
                </div>
            </div>
