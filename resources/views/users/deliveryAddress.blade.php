...
<body>
    <div id="body-container" class="container-fluid px-0">
        ...
        <div id="content" class="border content" style="padding-left: 0px;">
                ...
                <div class="del-address-container">
                    ...
                    <div class="button-container">
                        ...
                        {{-- <button class="edit-button" id="edit-btn" onclick="edit_function({{ $receiver->id }})"><a
                                href="#">Edit</a></button> --}}
                        <a type="button" href="/destroyaddress/{{ $receiver->id }}/delivery" id="delete-btn" class="delete-button">Delete</a>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div class="modal fade" id="add-address" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/storeaddress/delivery" method="POST">
                        @csrf
...
<script>
    ...
    edit_submit_btn.addEventListener('click', () => {
        ...
        edit_form.action = "/updateaddress/" + edit_id.textContent + '/delivery';
