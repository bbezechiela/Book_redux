    ...
    <div id="content" class="pe-0 border content">
                    ...
                    <div id="edit-exchange-div" class="modal-body container-fluid px-5">
                        <form id="exchange-form" action="/mylist/exchangepost" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select name="genre" id="edit-exchange-genre" class="w-100 mb-2 px-3 bg-light rounded">
                                        <option>Genre</option>
                                        <option value="Educational">Educational</option>
                                        <option value="Romance & Saga">Romance & Saga</option>
                                        <option value="Fantasy & Adventure">Fantasy & Adventure</option>
                                    ...
                                    <select name="condition" id="edit-exchange-condition" class="w-100 mb-2 px-3 bg-light rounded">
                                        <option>Condition</option>
                                        <option value="Old">Old</option>
                                        <option value="Fairly new">Fairly new</option>
                                        <option value="New">New</option>
                                    </select>
                                    <select name="language" class="w-100 mb-2 px-3 bg-light rounded" id="edit-exchange-language">
                                        <option>Language</option>
                                        <option value="English" selected>English</option>
                                    </select>
                                </div>
                                <input type="text" id="edit-exchange-title" name="title" class="w-100 mb-2 px-3 rounded"
                                    placeholder="Title">
                                <input type="text" id="edit-exchange-author" name="author" class="w-100 mb-2 px-3 rounded"
                                    placeholder="Author">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="price" id="edit-rent-rental-price"
                                            class="w-100 mb-2 px-3 rounded" placeholder="Rental Price">
                                        <input type="text" name="security_deposit" id="edit-rent-security-deposit" class="w-100 mb-2 px-3 rounded"
                                            placeholder="Security Deposit">
                                    </div>
                                    <input type="text" name="title" id="edit-rent-title" class="w-100 mb-2 px-3 rounded"
                                        placeholder="Title">
                                    <input type="text" name="author" id="edit-rent-author" class="w-100 mb-2 px-3 rounded"
                                        placeholder="Author">
                                    <input type="text" name="edition" id="edit-rent-edition" class="w-100 mb-2 px-3 rounded"
                                        placeholder="Edition">
                                    <select name="language" class="w-100 mb-2 px-3 bg-light rounded" id="edit-rent-language">
                                        <option>Language</option>
                                        <option value="English" selected>English</option>
                                    </select>
                                    <input type="text" name="rental_duration" id="edit-rent-rental-duration" class="w-100 mb-2 px-3 rounded"
                                        placeholder="Rental Duration">
                                    <textarea name="rental_terms_and_condition" id="edit-rent-rental-terms-and-condition" class="px-3 rounded mb-2" cols="30"
                                        rows="4" placeholder="Rental Terms and Condition"></textarea>
        ...
        <div class="modal fade" id="edit-shipping-fee" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button id="edit-back-shipping" class="btn text-decoration-none"><img src="assets/left_arrow.png"
                                alt="back"></button>
                        <h3 class="modal-title fs-6" id="staticBackdropLabel">Shipping Fee</h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
...
<script>
    ...
    function itemClicked(card) {
        ...
        if (edit_modal.value == 'Sale') {
            ...
            document.getElementById('edit-rent-rental-terms-and-condition').value = rental_terms_and_condition.textContent;
