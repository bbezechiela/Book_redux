                    ...
                    <div class="row justify-content-center mb-5">
                        ...
                        <div class="card col-3 m-2 shadow" style="width: 200px;">
                            ...
                            <div class="card-body py-0">
                                <p id="title_{{ $book->id }}" class="card-title mb-0 fw-bold title-text">
                                    {{ $book->title }}</p>
                                <p id="author_{{ $book->id }}" class="card-text mt-0 mb-2 author-text">
                                    {{ $book->author }}
                                </p>
                                <p id="genre_{{ $book->id }}" class="card-text mt-0 mb-2 genre-text"> {{ $book->genre }}
                                </p>
                                <div class="card-foot price d-flex justify-content-between align-items-center p-0">
                                    ...
                                    <div class="btns d-flex flex-row mb-2 dropdown">
                                        <button class="like-button"><i class="fa fa-thumbs-up fa-lg" aria-hidden="true"
                                                style="margin-right: 8px"><span>100</span></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
