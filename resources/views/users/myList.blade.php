                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Edition: <span>1st Edition</span></p>
                                                <p class="card-text">Condition: <span>Good</span></p>
                                                <p class="card-text">Description: <span>This is a sample description of
                                                        the
                                                        book I want to offer for exchange.</span></p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Genre: <span>Self-help</span></p>
                                                <p class="card-text">Format: <span>Paperback</span></p>
                                                <p class="card-text">Exchange Method Preference: <span>Delivery</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-12 d-flex justify-content-end mt-1 mb-3">
        ...
        <div class="modal fade" id="createListingModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <!-- Digital Exchange -->
                    <h1>NORE: PA REMOVE NALA AKO HAN FORM NA AADTO IGBAW HAHAHHA NA D-DISPLAY KASI GHAP AN KANAN ONLINE READING NA FORM</h1>
                    <div id="digital">
...
<script>
    const pdfPreview = () => {
        ...
        reader.onload = (e) => {
            ...
            pdfPrev.innerHTML =
                `<iframe src="${e.target.result}" width="100%" height="100%" frameborder="0"></iframe>`;
        };
    ...
    var create_exchange_listing_btn = document.getElementById('create-digital-exchange-listing');
    ...
    create_exchange_listing_btn.addEventListener('click', function() {
        list_category.value = 'Digital';
    ...
    list_category.addEventListener("change", function() {
        ...
        if (list_category.value == "Online Reading") {
            ...
            document.getElementById("digital").style.display = "none";
        } else if (list_category.value == "Physical Exchange") {
            document.getElementById("sale").style.display = "none";
            document.getElementById("exchange").style.display = "flex";
            document.getElementById("digital").style.display = "none";
        } else if (list_category.value == "Digital Exchange") {
            document.getElementById("sale").style.display = "none";
            document.getElementById("exchange").style.display = "none";
