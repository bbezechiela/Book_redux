    ...
    <div id="content" class="content">
        ...
        @foreach ($orders as $req)
            <div class="order-cart d-print-none">
                <div class="name-cart d-flex justify-content-between">
                    <div>
                        <a class="seller-name" href=""><span>{{ $req->book->user->name }}</span></a>
                        <button class="message-seller message-button"><i class="fa fa-commenting"
                                aria-hidden="true"></i></button>
                    </div>
                    <span class="order-text me-5 mt-0">{{ $req->book->status }} Request</span>
                </div>
                <div class="card mb-3" style="max-width: 100%; margin-left: 3em; margin-right: 2.1em;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('/images/book_cover/' . $req->book->back_cover) }}"
                                class="img w-100 h-100" alt="image">
                        </div>
                        <div class="col-md-4">
                            <div class="card-body">
                                <h5 class="card-title fw-bold">Title: <span
                                        class="fw-normal">{{ $req->book->title }}</span></h5>
                                <p class="card-text fw-bold">Author: <span
                                        class="fw-normal">{{ $req->book->author }}</span></p>
                                <p class="card-text fw-bold">Edition: <span
                                        class="fw-normal">{{ $req->book->edition }}</span></p>
        ...
        @if ($item->order->payment_method == 'Cash on Delivery' && ($item->order_status == 'Pending' || $item->order_status == 'Confirmed by seller'))
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card mb-3" style="max-width: 100%; margin-left: 3em; margin-right: 2.1em; border: none;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img id="requestSubmissionImg" class="img w-100 h-100" alt="image">
                            
                        </div>
                        <div class="col-md-4">
                            <div class="card-body">
                                <h5 class="card-title fw-bold">Title: <span id="title" class="fw-normal">City Limits</span></h5>
                                <p class="card-text fw-bold">Author: <span id="author" class="fw-normal">Pedro Penduko</span></p>
                                <p class="card-text fw-bold">Edition: <span id="edition" class="fw-normal">1st Edition</span></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-body">
                                <h5 class="card-title fw-bold">ISBN: <span id="isbn" class="fw-normal">124154238778</span></h5>
                                <p class="card-text fw-bold">Genre: <span id="genre" class="fw-normal">Self-help</span></p>
                                <p class="card-text fw-bold">Description: <span id="descrip" class="fw-normal">This is a sample description of
                                        the book
                                        I want to offer for exchange.</span></p>
                            </div>
                        </div>
...
<script>
    ...
    const requestSubmitionDetail = (id) => {
        var img = document.getElementById('requestSubmissionImg');
        ...
        fetch(`/request/${id}`, {
            ...
            .then(data => {
                console.log(data);
                img.src = `/images/book_cover/${data.back_cover}`;
