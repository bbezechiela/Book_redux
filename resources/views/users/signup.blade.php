...
<body>
    <div class="container-fluid p-4">
        ...
        <h1 id="create-acct" class="text-center fw-bold mx-auto w-50 pb-1" data-aos="fade-down"
            data-aos-duration="1500">Create Account</h1>
        <form id="form" action="./php-queries/create.php?signup=create" method="post"
                    ...
                    <div class="col container-fluid px-4 py-2">
                        ...
                        <div class="row px-3">
                            ...
                            <div class="col">
                                ...
                                <input type="checkbox" name="interest[]" id="horror"
                                    value="Horror & Supernatural">
