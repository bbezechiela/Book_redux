        ...
        <div id="content" class="content">
            ...
            {{-- <div class="card mb-3 book-details mx-4">
                <div class="row g-0">
                    <div class="col-md-4 p-5 stretch-card">
                        <img src="{{ asset('images/book_cover/' . $book->back_cover) }}" width="100%" height="100%" alt="book">                        
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="" data-bs-toggle="modal" class="btn cart-button"
                                data-bs-target="#exchange_request" style="margin-bottom: 1em;">Send Exchange Request
            ...
            <div id="carouselExampleRide" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <div class="row justify-content-center">
                            ...
                            <div class="col">
                                <div class="text-center">
                                    <img src="/assets/broke-empty.png"
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleRide"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon one" aria-hidden="true"
                        style="background-color: #d1c7c7;
                    border-radius: 50%;"></span>
                    <span class="visually-hidden one">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleRide"
                    data-bs-slide="next">
                    <span class="carousel-control-next-icon one" aria-hidden="true"
                        style="background-color: #d1c7c7;
                    border-radius: 50%;"></span>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        @elseif ($book->status = 'Online Reading')
                            <a href="" data-bs-toggle="modal" class="btn cart-button"
                                data-bs-target="#content_preview" style="margin-bottom: 1em;">Read Now
                                <i class="fa fa-eye" aria-hidden="true"
                                    style="margin-left: 8px; margin-right: 4px;"></i></a>
                        @endif
                    </div>
            ...
            <div class="col">
                <div class="d-flex align-items-center" style="width: 320px">
                    ...
                    <div class="user-info">
                        ...
                        <a href="/userlistings/{{ $book->user->id }}"><button class="view-profile-button"><i class="fa fa-eye"
