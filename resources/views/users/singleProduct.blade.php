        ...
        <div id="content" class="pe-0 border content">
            <ul class="nav bg-light sticky-top head-nav shadow py-2 px-4">
                <div class="w-100 d-flex mt-1 p-0">
                    ...
                    <a href="/" id="logo" class="px-2"><img class="img mt-2 me-5"
                ...
                <div class="position-absolute end-0">
                    ...
                    <button class="btn mx-1 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        data-bs-title="Profile"><img
                            src="{{ asset('images/profile_photos/' . session('profile_pic')) }}" alt="notification"
                            width="40" height="35" class="rounded-3"></button>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text">Condition: <span
                                        class="fw-bold">{{ $book_id->condition }}</span>
                                </p>
                                <p class="card-text">Product Description: <span
                                        class="fw-bold">{{ $book_id->description }}</span></p>
                                <p class="card-text"><small
