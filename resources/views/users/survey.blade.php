    ...
    <div class="col container-fluid px-4 py-2">
        <div class="row px-3">
            <div class="col-4">
                ...
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="fantasy" value="Fantasy & Adventure"
                        autocomplete="off" />
                    <label class="btn" for="fantasy">Fantasy & Adventure</label>
                </div>
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="science" value="Science Fiction"
                        autocomplete="off" />
                    <label class="btn" for="science">Science Fiction</label>
                </div>
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="history" value="Historical Fiction"
                        autocomplete="off" />
            ...
            <div class="col">
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="mystery" value="Mystery & Suspense"
                        autocomplete="off" />
                ...
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="horror" value="Horror & Supernatural"
                        autocomplete="off" />
            ...
            <div class="col-3">
                ...
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="crime" value="Crime & Thriller"
                        autocomplete="off" />
                    <label class="btn" for="crime">Crime & Thriller</label>
                </div>
                <div class="check-button">
                    <input type="checkbox" class="btn-check" name="interest[]" id="comedy" value="Comedy & Satire"
                        autocomplete="off" />
                    <label class="btn" for="comedy">Comedy & Satire</label>
                </div>
            </div>
        </div>
        <button type="button" class="submit-btn" id="submit-button"><a href="/home">Get started<i class="fa fa-arrow-right"
